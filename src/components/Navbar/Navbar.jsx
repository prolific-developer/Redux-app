...
const Navbar = () => {
  return (
    <div className='flex p-1 text-base m-2 bg-gray-50 mt-0 mb-0'>
        <div className='flex flex-1 m-3'>
            ...
            <h3 className='text-lg decoration-solid'>Redux</h3>
        </div>

        <div className='flex flex-2 justify-start m-2'>
            <h4 className='m-2'>Getting Started</h4>
            <h4 className='m-2'>Tutorial</h4>
            <h4 className='m-2'>Use Guide</h4>
            <h4 className='m-2'>API</h4>
            <h4 className='m-2'>FAQ</h4>
            <h4 className='m-2'>Best Practices</h4>
            <h4 className='m-2'>GitHub</h4>
            <h4 className='m-2'>Need Help?</h4>
        </div>
    </div>
  )
}
